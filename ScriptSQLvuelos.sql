...
/*NOTA:La consulta nùmero 4 no arroja ningun resultado dado que por los datos proporcionados por el reto,no existe ningun aerolinea que realice màs de dos vuelos por día por tanto */
